...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Sanjai M — Final-year AI & Data Science engineer building intelligent products, automation systems, and data-driven solutions." },
      { name: "author", content: "Sanjai M" },
      { property: "og:title", content: "Sanjai M — AI & Data Science Engineer" },
      { property: "og:description", content: "AI, Machine Learning, Automation & Full-Stack projects by Sanjai M." },
